function [handles ischanged] = eg_NewExperimentAutoELM(handles)
...
if handles.IsUpdating == 0
    ...
    if isfield(handles,'AutomationELM')
        path_name = handles.AutomationELM.path; 
        ischanged = 1; 
    else
...
if isfield(handles,'AutomationELM')
    handles.sound_files = dir(handles.FileString); 
    handles.sound_loader = handles.DefaultFileLoader; 
else
